...
body{width: 600px;  margin:auto; text-align: left; background-color: rgb(252, 243, 231);}}
			...
			<table border=0 style="width:300px;width:800px;">
				...
				<% }%>
					...
					for(int i=pm.getStartPage(); i<=pm.getEndPage();i++){
						%>
						<a href="<%=request.getContextPath()%>/board/boardList.do?page=<%=i%>"><%=i %>&searchType=<%=pm.getScri().getSearchType()%>&keyword=<%=pm.encoding(pm.getScri().getKeyword())%>"></a>
					<%	}			
					%>
				</td>
