...
function commentList(data){
	...
	$(data).each(function(){		
	str= str+ "<table style='border: 1px solid black;'><tr><td>"+this.cwriter	+""+"</td><td>"+this.ccontents+"</td><tr>";
	  var btn = document.createElement("button"); 
    btn.innerHTML = "삭제";
    btn.onclick = function() {
      alert("버튼 추가 버튼이 클릭되었습니다!");
    };
    str += "<tr><td colspan='2'></td><td colspan='1'>" + btn.outerHTML + "</td></tr>";
	});	
